...
if ($_GET["command"] == 'delete') {
    ...
    $expected_path = '/etc/openjvs/games/';
...
echo '<td><a href="editor.php?mode=jvs&mappingfile=' . urlencode($mappingfilepath) . '">edit</a> / <a href="mapping.php?command=delete&filetodelete=' . urlencode($mappingfilepath) . '">delete</a></td>';
echo '</tr>';
}
